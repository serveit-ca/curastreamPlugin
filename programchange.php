												...
												<ul class="sortable">
													<?php  
														foreach ($value['exercise'] as $keys => $values) { ?>																
															<li><span class="exerciseName"><?php echo $values['name'] ?></span> <span class="deleteExerciseEdit glyphicon glyphicon-trash" data-tab-index="1" data-exercise-id="<?php echo $values['id'] ?>"></span>
																<div class="row">
																	<div class="col-md-6">
																		<div class="form-group">
...
<script type="text/javascript">
	...
	jQuery(document).on('click','input[name="edit"]',function(){
		jQuery('.overlayAction').css('display','block');
	})
	jQuery(document).on('click','input[name="updateProgram"]',function(){
		jQuery('.overlayAction').css('display','block');
	})

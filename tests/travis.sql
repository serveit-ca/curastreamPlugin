...
CREATE TABLE wptests_cura_corp_tiers( id int(11) AUTO_INCREMENT, min_users int(5) NOT NULL, max_users int(5) NOT NULL, price_per_user numeric(6,2), is_default int(1), PRIMARY KEY (id));

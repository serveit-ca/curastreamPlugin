...
CREATE TABLE wptests_cura_corp_prices( id int(11) AUTO_INCREMENT, corp_id int(11) NOT NULL, tier_id int(11) NOT NULL, PRIMARY KEY (id));

CREATE TABLE wptests_cura_corp_tiers( id int(11) AUTO_INCREMENT, min_users int(5) NOT NULL, max_users int(5) NOT NULL, pricer_per_user numeric(6,2), is_default int(1), PRIMARY KEY (id));
